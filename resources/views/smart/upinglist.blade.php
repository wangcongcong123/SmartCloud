				...
				<div class="box-body no-padding">
					<ul class="nav nav-pills nav-stacked" id="leftuptab">
						<li><a href="{{route('main')}}"><i class="fa fa-files-o"></i>
								Files </a></li>
						<li class="active"><a href="{{route('upinglist')}}"><i
								class="fa fa-file"></i> Uploading List <span
		...
		<div class="col-md-9">
			<div class="box box-primary">
				<div class="box-header">
					<h3 class="box-title">Uploading List</h3>
					<a class="clear-upling pull-right" rel="popover"
				...
				<div class="box-body no-padding">
					...
					<div class="table-responsive"
						...
						<table class="table table-striped table-hover">
							...
							<tbody>
								<tr>
									<td class="upling-id">1.</td>
									<td class="upling-name">Upload software</td>
									...
									<td class="upling-label"><span class="badge bg-green">55%</span></td>
									<td class="upling-status"><a class="status-uploading">Uploading
											<i class="fa fa-spinner"></i>
									</a> <a class="status-finish" style="display: none">finished <i
											class="fa fa-hourglass-start"></i></a><a class="status-stop"
										style="display: none">stopped </a></td>
									<td class="upling-speed"><span class="badge bg-green">233k/s</span></td>
									<td class="upling-expect"><span class="badge bg-green">2
											minutes</span></td>
									<td class="uplingoptions"><a class="upling-start-stop"><i
											class="fa fa-play"></i>&nbsp;&nbsp;&nbsp;</a> <a
										class="upling-remove"><i class="fa fa-remove"></i></a></td>
								</tr>
...
$(document).ready(function() {
	...
	$(".clear-upling").hover(function(){$(this).popover('show');},function(){$(this).popover('hide');});

	$(".clear-upling").click(function(){
		swal('Oops...','clear clicked','info');
	});

	
	$(".upling-start-stop").click(function(){
		
		if($(this).children('i').hasClass('fa fa-play')){
			$(this).children('i').removeClass('fa fa-play').addClass('fa fa-stop');
			$(this).parent().siblings('.upling-status').children('.status-stop').show()
			$(this).parent().siblings('.upling-status').children('.status-uploading').hide()

		}else{
			$(this).children('i').removeClass('fa fa-stop').addClass('fa fa-play');
			$(this).parent().siblings('.upling-status').children('.status-stop').hide()
			$(this).parent().siblings('.upling-status').children('.status-uploading').show()
		}
	
});

$(".upling-remove").click(function(){
